...
/**
 * Shown when the sidebar's "Test yourself" entry is clicked. Two ways
 * to practice: the MCQ grammar quiz, or the N5 mock exam. Picking one
 * hands off to that quiz's own pre-quiz screen.
 */
